...
#-----------------------------------------------------------------------------
vendor_modify_apps := SamsungCamera2 SecSettingsProvider StockSettings
...
#-----------------------------------------------------------------------------
board_modify_apps := FlymeLauncher SystemUI Keyguard TeleService
...
override_property += \
    ...
    ro.product.model_romer=i9500_nian0114
