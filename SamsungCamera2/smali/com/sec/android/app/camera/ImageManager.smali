...
.method public static makeImageList(Landroid/content/ContentResolver;Lcom/sec/android/app/camera/ImageManager$ImageListParam;)Lcom/sec/android/app/camera/gallery/IImageList;
    ...
    iget-object v14, v0, Lcom/sec/android/app/camera/ImageManager$ImageListParam;->mLocation:Lcom/sec/android/app/camera/ImageManager$DataLocation;

    .line 322
    .local v14, "location":Lcom/sec/android/app/camera/ImageManager$DataLocation;
    move-object/from16 v0, p1

    iget v9, v0, Lcom/sec/android/app/camera/ImageManager$ImageListParam;->mInclusion:I

    .line 323
    .local v9, "inclusion":I
    move-object/from16 v0, p1
    ...
    iget-object v15, v0, Lcom/sec/android/app/camera/ImageManager$ImageListParam;->mSingleImageUri:Landroid/net/Uri;

    .line 326
    .local v15, "singleImageUri":Landroid/net/Uri;
    move-object/from16 v0, p1

    iget-boolean v10, v0, Lcom/sec/android/app/camera/ImageManager$ImageListParam;->mIsEmptyImageList:Z

    .line 328
    .local v10, "isEmptyImageList":Z
    if-nez v10, :cond_0
    ...
    .line 329
    :cond_0
    new-instance v13, Lcom/sec/android/app/camera/ImageManager$EmptyImageList;

    const/4 v1, 0x0

    invoke-direct {v13, v1}, Lcom/sec/android/app/camera/ImageManager$EmptyImageList;-><init>(Lcom/sec/android/app/camera/ImageManager$1;)V
    ...
    .line 333
    new-instance v13, Lcom/sec/android/app/camera/gallery/SingleImageList;

    move-object/from16 v0, p0

    invoke-direct {v13, v0, v15}, Lcom/sec/android/app/camera/gallery/SingleImageList;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    .line 340
    .local v8, "haveSdCard":Z
    new-instance v12, Ljava/util/ArrayList;

    invoke-direct {v12}, Ljava/util/ArrayList;-><init>()V

    .line 342
    .local v12, "l":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/sec/android/app/camera/gallery/BaseImageList;>;"
    if-eqz v8, :cond_4
    ...
    .line 360
    .local v7, "drm_image_uri":Landroid/net/Uri;
    new-instance v1, Lcom/sec/android/app/camera/gallery/DrmImageList;

    move-object/from16 v0, p0

    invoke-direct {v1, v0, v7, v5, v6}, Lcom/sec/android/app/camera/gallery/DrmImageList;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;ILjava/lang/String;)V

    invoke-virtual {v12, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 367
    .end local v7    # "drm_image_uri":Landroid/net/Uri;
    :cond_7
    ...
    .line 368
    .local v11, "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/sec/android/app/camera/gallery/BaseImageList;>;"
    :cond_8
    :goto_1
    ...
    check-cast v16, Lcom/sec/android/app/camera/gallery/BaseImageList;

    .line 370
    .local v16, "sublist":Lcom/sec/android/app/camera/gallery/BaseImageList;
    invoke-virtual/range {v16 .. v16}, Lcom/sec/android/app/camera/gallery/BaseImageList;->isEmpty()Z
    ...
    .line 371
    invoke-virtual/range {v16 .. v16}, Lcom/sec/android/app/camera/gallery/BaseImageList;->close()V
    ...
    .line 376
    .end local v16    # "sublist":Lcom/sec/android/app/camera/gallery/BaseImageList;
    :cond_9
    ...
    check-cast v13, Lcom/sec/android/app/camera/gallery/BaseImageList;

    .line 378
    .local v13, "list":Lcom/sec/android/app/camera/gallery/BaseImageList;
    goto/16 :goto_0

    .line 381
    .end local v13    # "list":Lcom/sec/android/app/camera/gallery/BaseImageList;
    :cond_a
    new-instance v17, Lcom/sec/android/app/camera/gallery/ImageListUber;
    ...
    .local v17, "uber":Lcom/sec/android/app/camera/gallery/ImageListUber;
